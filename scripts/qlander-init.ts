...
function createSinglePageEditMap(sections: any[]) {
  ...
  map["site.info"] = { route: "*", label: "Site information", scope: "global-content", contentFile: "data/site.json", jsonPath: "$", component: "SiteData", safeFields: ["name", "description", "url", "launchStatus", "locale", "logo", "socialImage", "email", "phone", "contactUrl", "complianceNote", "address.street", "address.city", "address.region", "address.postalCode", "address.country", "social.linkedin", "social.x", "social.facebook", "social.instagram", "social.youtube"], affectedRoutes: "all" };
