...
4. Run `pnpm build` and `pnpm qlander:check`.
...
5. Run `pnpm build` and `pnpm qlander:check`.
...
4. Run `pnpm qlander:check -- --launch`.
...
3. Re-run `pnpm qlander:check` after final content changes.
